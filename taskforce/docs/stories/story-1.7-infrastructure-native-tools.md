...
- [ ] All 7+ native tools copied to `infrastructure/tools/native/`
- [ ] Each tool implements ToolProtocol
- [ ] All tool logic preserved (no behavioral changes)
- [ ] Imports updated to taskforce paths
- [ ] Unit tests for each tool (≥80% coverage per tool)
- [ ] Integration tests verify compatibility with Agent V2
